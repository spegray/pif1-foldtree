...
- Settings: --num-models 1 --num-recycle 3 --num-seeds 1 --model-type alphafold2_ptm
  (>1500 aa also used --max-msa 512:1024). Memory-safe config: TF_FORCE_UNIFIED_MEMORY=0.

## Folded: 238 / 248  (this folder, one <ACCESSION>.pdb each)

## Excluded: 10 / 248 — GPU-model segfault on their MSA (localcolabfold + driver 610.62).
## 9 are the same recurring 192-aa fragment across genomes; 1 is a 111-aa fragment.
## Marked segfault-unfoldable; not modeled. Excluded accessions (length):
  - A0A9P7MFY7	111 aa
  - A0A3L6MPD3	192 aa
  - A0A3L6MQ31	192 aa
  - A0A3L6MRC3	192 aa
